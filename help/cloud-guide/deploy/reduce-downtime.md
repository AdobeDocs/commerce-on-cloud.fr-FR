...
1. [Mettre à niveau vers le package `ece-tools`](../dev-tools/install-package.md) ou [mettre à jour la version `ece-tools`](../dev-tools/update-package.md)
