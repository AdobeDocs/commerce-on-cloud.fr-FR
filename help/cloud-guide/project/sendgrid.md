...
>
> Pour activer votre service SendGrid propriétaire ou mettre à jour une clé API existante, [envoyez un ticket d’assistance Adobe Commerce](https://experienceleague.adobe.com/fr/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#submit-ticket) et incluez la clé API de votre compte SendGrid.
