...
| `/.magento/services.yaml` | Un fichier de configuration qui définit une instance MySQL (MariaDB), Redis ou Valkey, et OpenSearch ou Elasticsearch. Voir [ Configuration des services ](../services/services-yaml.md). |
