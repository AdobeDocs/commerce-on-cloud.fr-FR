...
Pour créer une règle de prix, consultez le [Guide de l’utilisateur d’](https://experienceleague.adobe.com/docs/commerce-admin/marketing/promotions/catalog-rules/price-rules-catalog-create.html).
