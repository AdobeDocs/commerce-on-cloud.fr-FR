...
1. Cliquez sur **[!UICONTROL Administration]** et sélectionnez l’une des options suivantes dans la liste :
   ...
   - **[!UICONTROL User management]** d’ajouter des utilisateurs, de gérer les utilisateurs actifs et les invitations en attente, et de supprimer ou désactiver les utilisateurs qui n’ont plus besoin d’accès, par exemple les utilisateurs qui ont quitté votre entreprise.
...
>- Informations d’identification pour accéder à l’[administrateur](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/user-accounts/permissions) pour l’environnement
...
1. Recherchez votre clé de licence New Relic à partir de l’interface de ligne de commande [!DNL Cloud Console] ou Cloud.
   ...
   **[!DNL Cloud Console]méthode** :
   ...
   - Développez la section **Service** pour afficher la clé de licence.
...
1. Ajoutez la clé de licence New Relic à un environnement à l’aide de l’interface de ligne de commande `magento-cloud`.
   ...
   Vous pouvez éventuellement l’ajouter à partir de l’[administration &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/monitor/new-relic/new-relic-service).
...
Pour plus d’informations, consultez la présentation du service New Relic [&#128279;](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/monitor/new-relic/new-relic-service).
