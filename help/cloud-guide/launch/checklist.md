...
1. Mettez à jour l’URL de base.
   ...
   **REMARQUE** : vous pouvez également mettre à jour l’URL de base à partir de l’Administration. Voir [URL des magasins](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/site-store/store-urls) dans le _Guide des magasins et de l’expérience d’achat Adobe Commerce_.
