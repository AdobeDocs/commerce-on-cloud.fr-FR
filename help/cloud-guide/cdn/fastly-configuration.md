...
description: Découvrez comment configurer et tester la mise en cache rapide, les fragments de code VCL et le pare-feu d’application web (WAF) pour vos environnements d’évaluation et de production.
...
Suivez les étapes suivantes pour activer, configurer et tester Fastly au cours des premières étapes du processus de développement de votre site afin de permettre un accès sécurisé à votre site.
...
1. Cliquez sur **[!UICONTROL Stores]** > **[!UICONTROL Settings]** > **[!UICONTROL Configuration]** > **[!UICONTROL Advanced]** > **[!UICONTROL System]** et développez **[!UICONTROL Full Page Cache]**.

   ![Développer pour sélectionner Fastly](../../assets/cdn/fastly-menu.png)

1. Dans la section _[!UICONTROL Caching Application]_, supprimez la sélection de **[!UICONTROL Use system value]**, puis sélectionnez **[!UICONTROL Fastly CDN]**&#x200B;dans la liste déroulante.

   ![Choisir rapidement](../../assets/cdn/fastly-enable-admin.png)

1. Développez **[!UICONTROL Fastly Configuration]** et [choisissez les options de mise en cache](https://github.com/fastly/fastly-magento2/blob/master/Documentation/CONFIGURATION.md#configure-the-module).

1. Après avoir configuré les options de mise en cache, cliquez sur **[!UICONTROL Save Config]** en haut de la page.

1. Effacez le cache en fonction de la notification.

1. Continuez à configurer Fastly en revenant à **[!UICONTROL Stores]** > **[!UICONTROL Settings]** > **[!UICONTROL Configuration]** > **[!UICONTROL Advanced]** > **[!UICONTROL System]** > **[!UICONTROL Fastly Configuration]**.

### Tester les informations d’identification Fastly

1. Dans Admin, accédez à **[!UICONTROL Stores]** > **[!UICONTROL Settings]** > **[!UICONTROL Configuration]** > **[!UICONTROL Advanced]** > **[!UICONTROL System]** > **[!UICONTROL Fastly Configuration]**.

1. Si nécessaire, ajoutez les valeurs **[!UICONTROL Fastly service ID]** et **[!UICONTROL API token]** pour votre environnement de projet.
...
1. Cliquez sur **[!UICONTROL Test credentials]**.

1. Si le test réussit, cliquez sur **[!UICONTROL Save Config]**, puis effacez le cache.
...
1. Dans la section _[!UICONTROL Fastly Configuration]_, cliquez sur **[!UICONTROL Upload VCL to Fastly]**&#x200B;comme le montre la figure suivante.
...
Une fois la validation du domaine terminée, Adobe fournit le certificat Let’s Encrypt TLS/SSL et le charge dans des environnements d’évaluation ou de production actifs. Ce processus peut prendre jusqu’à 12 heures. Adobe vous recommande de terminer les mises à jour de la configuration DNS plusieurs jours à l’avance afin d’éviter les retards de développement du site et de lancement.
...
1. Dans la réponse, vérifiez les [en-têtes](fastly-troubleshooting.md#check-cache-hit-and-miss-response-headers) pour vous assurer que Fastly fonctionne. Par exemple, consultez les en-têtes uniques suivants dans la réponse :
...
>[!TIP]
>
> Si vous rencontrez des problèmes avec les services Fastly dans vos environnements Adobe Commerce, consultez l’[utilitaire de dépannage Fastly Adobe Commerce](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-29661).
