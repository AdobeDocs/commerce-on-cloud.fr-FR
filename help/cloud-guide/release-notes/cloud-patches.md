...
- ![Icône de correction](../../assets/fix.svg) **Correctif** - Le correctif pour le [l’extraction échoue lorsque la minification et le regroupement JS sont activés](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997)) problème décrit dans la *Base de connaissances Commerce » (tickets AC-15867 et ACSD-68617).<!-- MCLOUD-14191 -->
