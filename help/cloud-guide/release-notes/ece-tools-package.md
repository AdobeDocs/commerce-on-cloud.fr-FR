...
- ![icône de correction](../../assets/fix.svg) **couverture de test fonctionnel Valkey 8.5** : couverture améliorée pour la configuration du cache Symfony L2.<!-- MCLOUD-15487 -->
- ![Icône de correction](../../assets/fix.svg) **Améliorations de la mise en cache**—Résolution d’un problème d’isolation du cache de page.<!-- MCLOUD-15509 -->
- ![icône de correction](../../assets/fix.svg) **améliorations de Redis et Valkey** : amélioration de la gestion des `REDIS_BACKEND` et des `VALKEY_BACKEND` pour prendre en charge les configurations de cache Redis et Valkey héritées et modernes (Symfony Cache, 2.4.9+).<!-- MCLOUD-15546 -->
...
- ![nouvelle icône](../../assets/new.svg) **RabbitMQ**—Ajout de la prise en charge de RabbitMQ 4.3.<!-- MCLOUD-15088 -->
- ![icône de correction](../../assets/fix.svg) **configuration Redis Lua** - Ajout de la prise en charge de `USE_LUA_ON_GC` et `LUA_KEY` obsolète.<!-- MCLOUD-15048 -->
- ![Icône de correction](../../assets/fix.svg) **Cache Symfony L2**-Compatibilité avec la configuration du cache d’Adobe Commerce 2.4.9 corrigée avec les outils ECE<!-- MCLOUD-15114 -->
...
- ![icône de correctif](../../assets/fix.svg) **correctifs PHP 8.4**-compatibilité de type ajoutée.<!-- MCLOUD-13965 -->
- ![icône de correction](../../assets/fix.svg) **validateur de fin de vie**-dates de services de fin de vie mises à jour.<!-- MCLOUD-13929 -->
- ![nouvelle icône](../../assets/new.svg) **Valkey**-Ajout des tests fonctionnels PHP 8.2 et PHP 8.3.<!-- MCLOUD-13610 -->
- ![icône de correction](../../assets/fix.svg) **validateur Valkey**-correction du message d&#39;avertissement des outils ECE.<!-- MCLOUD-13896 -->
- ![icône de correction](../../assets/fix.svg) **outils ECE**-Ajout d’améliorations aux tests unitaires.<!-- MCLOUD-13838 -->
- ![nouvelle icône](../../assets/new.svg) **Validateur pour les services**-Ajout de nouvelles versions de prise en charge d’Opensearch, MariaDB et PHP.<!-- MCLOUD-13923 -->
- ![nouvelle icône](../../assets/new.svg) **Opensearch3**-Ajout de la prise en charge d’Opensearch3.<!-- MCLOUD-13763 -->
- ![Icône de correction](../../assets/fix.svg) **Prise en charge d’Opensearch pour 2.4.4-p7/p12**-Mise à jour du script de validation.<!-- MCLOUD-13945 -->
- ![nouvelle icône](../../assets/new.svg) **Tests Opensearch3**-Tests fonctionnels ajoutés.<!-- MCLOUD-13769 -->
...
- ![icône de correction](../../assets/fix.svg) **cache:flush journalisation** : amélioration des entrées de journal pour indiquer le début et la fin de l’étape de `cache:flush`.<!--MCLOUD-7503-->
...
- ![nouvelle icône](../../assets/new.svg) **Mises à jour de l’infrastructure**—
  ...
  - ![nouvelle icône](../../assets/new.svg) **Fonctionnalités de correction mises à jour**—Déplacement de la fonctionnalité de correction du module ECE-Tools vers un module `magento-cloud-patches` distinct. Pendant le déploiement, `ece-tools` utilise le nouveau package pour appliquer des correctifs. Voir [Notes de mise à jour des correctifs cloud](cloud-patches.md).<!--MAGECLOUD-4567-->
...
>[!NOTE]
>
>Avant d&#39;effectuer la mise à jour vers la version 2002.1.0 de ECE-Tools, passez en revue les [modifications rétrocompatibles](backward-incompatible-changes.md) pour en savoir plus sur les modifications qui pourraient nécessiter la mise à jour d&#39;Adobe Commerce sur la configuration ou les processus de projet d&#39;infrastructure cloud.
